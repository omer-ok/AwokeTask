...
public class SimpleLocation {
    ...
    private   long   timeDiffOfPreProviderEnable=0;
    ...
    public void beginUpdates() {
        ...
        //mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 1000, 0,getCriteria(), mGPSLocationListener);

        //mLocationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 1000, 0, mLocationListener);
        mLocationManager.requestLocationUpdates(100,1, getCriteria(), mLocationListener, null);
    ...
    private LocationListener createLocationListener() {
        return new LocationListener() {
            ...
            public void onProviderEnabled(String provider) {
                ...
                if(currentTime-timeDiffOfPreProviderEnable>=3000)
                {
                    timeDiffOfPreProviderEnable=System.currentTimeMillis();

                    if(mListener!=null)
                    {
                        mListener.onGPSStatusChanged(true);
                    }
                }
            }
            ...
            public void onProviderDisabled(String provider) {
                ...
                if(mListener!=null)
                {
                    mListener.onGPSStatusChanged(false);
                }
            }
