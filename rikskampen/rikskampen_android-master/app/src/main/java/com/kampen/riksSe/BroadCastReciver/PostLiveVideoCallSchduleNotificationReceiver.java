...
public class PostLiveVideoCallSchduleNotificationReceiver extends GCoreWakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(isLogIn){
            ...
            sendNotificationVideoCallSessionLive(context);
    ...
    public void startAlarmPostActivityChange(Context context) {
        ...
        Intent myIntent = new Intent(context,PostLiveVideoCallSchduleNotificationReceiver.class);
    ...
    private void sendNotificationVideoCallSessionLive(Context context) {

        String title = context.getResources().getString(R.string.General_Video_Session_Live);
        String messageBody = "RiksKapen Team";
        Intent notificationIntent = new Intent(context, ContestantSchduledLiveVideoCallActivity.class);
    ...
    public void cancelAlarmIfExists(Context mContext,int requestCode){
        try {
            Intent myIntent = new Intent(mContext, PostLiveVideoCallSchduleNotificationReceiver.class);
